...
pub extern fn git_libgit2_prerelease() [*c]const u8;
...
pub const GIT_FEATURE_HTTP_PARSER: c_int = 16;
pub const GIT_FEATURE_REGEX: c_int = 32;
pub const GIT_FEATURE_I18N: c_int = 64;
pub const GIT_FEATURE_AUTH_NTLM: c_int = 128;
pub const GIT_FEATURE_AUTH_NEGOTIATE: c_int = 256;
pub const GIT_FEATURE_COMPRESSION: c_int = 512;
pub const GIT_FEATURE_SHA1: c_int = 1024;
pub const GIT_FEATURE_SHA256: c_int = 2048;
pub const git_feature_t = c_uint;
pub extern fn git_libgit2_features() c_int;
pub extern fn git_libgit2_feature_backend(feature: git_feature_t) [*c]const u8;
...
pub const GIT_OPT_GET_OWNER_VALIDATION: c_int = 35;
pub const GIT_OPT_SET_OWNER_VALIDATION: c_int = 36;
pub const GIT_OPT_GET_HOMEDIR: c_int = 37;
pub const GIT_OPT_SET_HOMEDIR: c_int = 38;
pub const GIT_OPT_SET_SERVER_CONNECT_TIMEOUT: c_int = 39;
pub const GIT_OPT_GET_SERVER_CONNECT_TIMEOUT: c_int = 40;
pub const GIT_OPT_SET_SERVER_TIMEOUT: c_int = 41;
pub const GIT_OPT_GET_SERVER_TIMEOUT: c_int = 42;
pub const GIT_OPT_SET_USER_AGENT_PRODUCT: c_int = 43;
pub const GIT_OPT_GET_USER_AGENT_PRODUCT: c_int = 44;
pub const GIT_OPT_ADD_SSL_X509_CERT: c_int = 45;
pub const git_libgit2_opt_t = c_uint;
pub extern fn git_libgit2_opts(option: c_int, ...) c_int;
pub const GIT_BUILDINFO_CPU: c_int = 1;
pub const GIT_BUILDINFO_COMMIT: c_int = 2;
pub const git_buildinfo_t = c_uint;
pub extern fn git_libgit2_buildinfo(info: git_buildinfo_t) [*c]const u8;
...
pub const GIT_OID_SHA1: c_int = 1;
pub const git_oid_t = c_uint;
pub const struct_git_oid = extern struct {
    id: [20]u8 = @import("std").mem.zeroes([20]u8),
};
...
pub const struct_git_odb_stream = extern struct {
    backend: ?*git_odb_backend = @import("std").mem.zeroes(?*git_odb_backend),
    mode: c_uint = @import("std").mem.zeroes(c_uint),
    hash_ctx: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    declared_size: git_object_size_t = @import("std").mem.zeroes(git_object_size_t),
    received_bytes: git_object_size_t = @import("std").mem.zeroes(git_object_size_t),
    read: ?*const fn ([*c]git_odb_stream, [*c]u8, usize) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_odb_stream, [*c]u8, usize) callconv(.c) c_int),
    write: ?*const fn ([*c]git_odb_stream, [*c]const u8, usize) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_odb_stream, [*c]const u8, usize) callconv(.c) c_int),
    finalize_write: ?*const fn ([*c]git_odb_stream, [*c]const git_oid) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_odb_stream, [*c]const git_oid) callconv(.c) c_int),
    free: ?*const fn ([*c]git_odb_stream) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]git_odb_stream) callconv(.c) void),
};
pub const git_odb_writepack = struct_git_odb_writepack;
pub const struct_git_indexer_progress = extern struct {
    total_objects: c_uint = @import("std").mem.zeroes(c_uint),
    indexed_objects: c_uint = @import("std").mem.zeroes(c_uint),
    received_objects: c_uint = @import("std").mem.zeroes(c_uint),
    local_objects: c_uint = @import("std").mem.zeroes(c_uint),
    total_deltas: c_uint = @import("std").mem.zeroes(c_uint),
    indexed_deltas: c_uint = @import("std").mem.zeroes(c_uint),
    received_bytes: usize = @import("std").mem.zeroes(usize),
};
pub const git_indexer_progress = struct_git_indexer_progress;
pub const struct_git_odb_writepack = extern struct {
    backend: ?*git_odb_backend = @import("std").mem.zeroes(?*git_odb_backend),
    append: ?*const fn ([*c]git_odb_writepack, ?*const anyopaque, usize, [*c]git_indexer_progress) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_odb_writepack, ?*const anyopaque, usize, [*c]git_indexer_progress) callconv(.c) c_int),
    commit: ?*const fn ([*c]git_odb_writepack, [*c]git_indexer_progress) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_odb_writepack, [*c]git_indexer_progress) callconv(.c) c_int),
    free: ?*const fn ([*c]git_odb_writepack) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]git_odb_writepack) callconv(.c) void),
};
...
pub const struct_git_time = extern struct {
    time: git_time_t = @import("std").mem.zeroes(git_time_t),
    offset: c_int = @import("std").mem.zeroes(c_int),
    sign: u8 = @import("std").mem.zeroes(u8),
};
...
pub const struct_git_signature = extern struct {
    ...
    when: git_time = @import("std").mem.zeroes(git_time),
};
...
pub const struct_git_remote_head = extern struct {
    local: c_int = @import("std").mem.zeroes(c_int),
    oid: git_oid = @import("std").mem.zeroes(git_oid),
    loid: git_oid = @import("std").mem.zeroes(git_oid),
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    symref_target: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
pub const git_remote_head = struct_git_remote_head;
pub const git_transport_message_cb = ?*const fn ([*c]const u8, c_int, ?*anyopaque) callconv(.c) c_int;
...
pub const struct_git_credential = extern struct {
    credtype: git_credential_t = @import("std").mem.zeroes(git_credential_t),
    free: ?*const fn ([*c]git_credential) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]git_credential) callconv(.c) void),
};
pub const git_credential = struct_git_credential;
pub const git_credential_acquire_cb = ?*const fn ([*c][*c]git_credential, [*c]const u8, [*c]const u8, c_uint, ?*anyopaque) callconv(.c) c_int;
...
pub const struct_git_cert = extern struct {
    cert_type: git_cert_t = @import("std").mem.zeroes(git_cert_t),
};
pub const git_cert = struct_git_cert;
pub const git_transport_certificate_check_cb = ?*const fn ([*c]git_cert, c_int, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
pub const git_indexer_progress_cb = ?*const fn ([*c]const git_indexer_progress, ?*anyopaque) callconv(.c) c_int;
pub const git_packbuilder_progress = ?*const fn (c_int, u32, u32, ?*anyopaque) callconv(.c) c_int;
pub const git_push_transfer_progress_cb = ?*const fn (c_uint, c_uint, usize, ?*anyopaque) callconv(.c) c_int;
pub const git_push_update_reference_cb = ?*const fn ([*c]const u8, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
pub const git_push_negotiation = ?*const fn ([*c][*c]const git_push_update, usize, ?*anyopaque) callconv(.c) c_int;
pub const git_transport_cb = ?*const fn ([*c]?*git_transport, ?*git_remote, ?*anyopaque) callconv(.c) c_int;
pub const git_remote_ready_cb = ?*const fn (?*git_remote, c_int, ?*anyopaque) callconv(.c) c_int;
pub const git_url_resolve_cb = ?*const fn ([*c]git_buf, [*c]const u8, c_int, ?*anyopaque) callconv(.c) c_int;
pub const struct_git_remote_callbacks = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    sideband_progress: git_transport_message_cb = @import("std").mem.zeroes(git_transport_message_cb),
    completion: ?*const fn (git_remote_completion_t, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn (git_remote_completion_t, ?*anyopaque) callconv(.c) c_int),
    credentials: git_credential_acquire_cb = @import("std").mem.zeroes(git_credential_acquire_cb),
    certificate_check: git_transport_certificate_check_cb = @import("std").mem.zeroes(git_transport_certificate_check_cb),
    transfer_progress: git_indexer_progress_cb = @import("std").mem.zeroes(git_indexer_progress_cb),
    update_tips: ?*const fn ([*c]const u8, [*c]const git_oid, [*c]const git_oid, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const git_oid, [*c]const git_oid, ?*anyopaque) callconv(.c) c_int),
    pack_progress: git_packbuilder_progress = @import("std").mem.zeroes(git_packbuilder_progress),
    push_transfer_progress: git_push_transfer_progress_cb = @import("std").mem.zeroes(git_push_transfer_progress_cb),
    push_update_reference: git_push_update_reference_cb = @import("std").mem.zeroes(git_push_update_reference_cb),
    push_negotiation: git_push_negotiation = @import("std").mem.zeroes(git_push_negotiation),
    transport: git_transport_cb = @import("std").mem.zeroes(git_transport_cb),
    remote_ready: git_remote_ready_cb = @import("std").mem.zeroes(git_remote_ready_cb),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    resolve_url: git_url_resolve_cb = @import("std").mem.zeroes(git_url_resolve_cb),
    update_refs: ?*const fn ([*c]const u8, [*c]const git_oid, [*c]const git_oid, ?*git_refspec, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const git_oid, [*c]const git_oid, ?*git_refspec, ?*anyopaque) callconv(.c) c_int),
};
...
pub const struct_git_writestream = extern struct {
    write: ?*const fn ([*c]git_writestream, [*c]const u8, usize) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_writestream, [*c]const u8, usize) callconv(.c) c_int),
    close: ?*const fn ([*c]git_writestream) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_writestream) callconv(.c) c_int),
    free: ?*const fn ([*c]git_writestream) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]git_writestream) callconv(.c) void),
};
pub const struct_git_mailmap = opaque {};
pub const git_mailmap = struct_git_mailmap;
pub const struct_git_oidarray = extern struct {
    ids: [*c]git_oid = @import("std").mem.zeroes([*c]git_oid),
...
pub const struct_git_indexer_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    progress_cb: git_indexer_progress_cb = @import("std").mem.zeroes(git_indexer_progress_cb),
    progress_cb_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    verify: u8 = @import("std").mem.zeroes(u8),
};
...
pub extern fn git_indexer_name(idx: ?*const git_indexer) [*c]const u8;
pub extern fn git_indexer_free(idx: ?*git_indexer) void;
pub const GIT_ODB_LOOKUP_NO_REFRESH: c_int = 1;
pub const git_odb_lookup_flags_t = c_uint;
pub const git_odb_foreach_cb = ?*const fn ([*c]const git_oid, ?*anyopaque) callconv(.c) c_int;
pub const git_odb_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    oid_type: git_oid_t = @import("std").mem.zeroes(git_oid_t),
};
pub extern fn git_odb_new(odb: [*c]?*git_odb) c_int;
pub extern fn git_odb_open(odb_out: [*c]?*git_odb, objects_dir: [*c]const u8) c_int;
pub extern fn git_odb_add_disk_alternate(odb: ?*git_odb, path: [*c]const u8) c_int;
pub extern fn git_odb_free(db: ?*git_odb) void;
pub extern fn git_odb_read(obj: [*c]?*git_odb_object, db: ?*git_odb, id: [*c]const git_oid) c_int;
pub extern fn git_odb_read_prefix(obj: [*c]?*git_odb_object, db: ?*git_odb, short_id: [*c]const git_oid, len: usize) c_int;
...
pub extern fn git_odb_exists_ext(db: ?*git_odb, id: [*c]const git_oid, flags: c_uint) c_int;
...
pub const struct_git_odb_expand_id = extern struct {
    id: git_oid = @import("std").mem.zeroes(git_oid),
    length: c_ushort = @import("std").mem.zeroes(c_ushort),
    type: git_object_t = @import("std").mem.zeroes(git_object_t),
};
...
pub extern fn git_odb_refresh(db: ?*git_odb) c_int;
...
pub extern fn git_odb_hash(oid: [*c]git_oid, data: ?*const anyopaque, len: usize, object_type: git_object_t) c_int;
pub extern fn git_odb_hashfile(oid: [*c]git_oid, path: [*c]const u8, object_type: git_object_t) c_int;
...
pub extern fn git_object_type_is_valid(@"type": git_object_t) c_int;
...
pub extern fn git_object_rawcontent_is_valid(valid: [*c]c_int, buf: [*c]const u8, len: usize, object_type: git_object_t) c_int;
...
// include/git2/commit.h:442:15: warning: struct demoted to opaque type - has bitfield
pub const git_commit_create_options = opaque {};
pub extern fn git_commit_create_from_stage(id: [*c]git_oid, repo: ?*git_repository, message: [*c]const u8, opts: ?*const git_commit_create_options) c_int;
...
pub const git_commit_create_cb = ?*const fn ([*c]git_oid, [*c]const git_signature, [*c]const git_signature, [*c]const u8, [*c]const u8, ?*const git_tree, usize, [*c]?*const git_commit, ?*anyopaque) callconv(.c) c_int;
pub const struct_git_commitarray = extern struct {
    commits: [*c]const ?*git_commit = @import("std").mem.zeroes([*c]const ?*git_commit),
    count: usize = @import("std").mem.zeroes(usize),
};
pub const git_commitarray = struct_git_commitarray;
pub extern fn git_commitarray_dispose(array: [*c]git_commitarray) void;
...
pub const git_repository_init_options = extern struct {
    ...
    mode: u32 = @import("std").mem.zeroes(u32),
    workdir_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    description: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    template_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    initial_head: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    origin_url: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
...
pub const GIT_REPOSITORY_ITEM_WORKTREE_CONFIG: c_int = 14;
pub const GIT_REPOSITORY_ITEM__LAST: c_int = 15;
...
pub const git_repository_fetchhead_foreach_cb = ?*const fn ([*c]const u8, [*c]const u8, [*c]const git_oid, c_uint, ?*anyopaque) callconv(.c) c_int;
...
pub const git_repository_mergehead_foreach_cb = ?*const fn ([*c]const git_oid, ?*anyopaque) callconv(.c) c_int;
...
pub extern fn git_repository_set_head_detached(repo: ?*git_repository, committish: [*c]const git_oid) c_int;
pub extern fn git_repository_set_head_detached_from_annotated(repo: ?*git_repository, committish: ?*const git_annotated_commit) c_int;
...
pub extern fn git_repository_oid_type(repo: ?*git_repository) git_oid_t;
pub extern fn git_repository_commit_parents(commits: [*c]git_commitarray, repo: ?*git_repository) c_int;
...
pub const git_treebuilder_filter_cb = ?*const fn (?*const git_tree_entry, ?*anyopaque) callconv(.c) c_int;
...
pub const git_treewalk_cb = ?*const fn ([*c]const u8, ?*const git_tree_entry, ?*anyopaque) callconv(.c) c_int;
...
pub const git_tree_update = extern struct {
    action: git_tree_update_t = @import("std").mem.zeroes(git_tree_update_t),
    id: git_oid = @import("std").mem.zeroes(git_oid),
    filemode: git_filemode_t = @import("std").mem.zeroes(git_filemode_t),
...
pub const struct_git_strarray = extern struct {
    strings: [*c][*c]u8 = @import("std").mem.zeroes([*c][*c]u8),
    count: usize = @import("std").mem.zeroes(usize),
};
...
pub const git_reference_foreach_cb = ?*const fn (?*git_reference, ?*anyopaque) callconv(.c) c_int;
pub const git_reference_foreach_name_cb = ?*const fn ([*c]const u8, ?*anyopaque) callconv(.c) c_int;
...
pub const GIT_DIFF_FLAG_VALID_SIZE: c_int = 16;
...
pub const git_diff_file = extern struct {
    id: git_oid = @import("std").mem.zeroes(git_oid),
    path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    size: git_object_size_t = @import("std").mem.zeroes(git_object_size_t),
    flags: u32 = @import("std").mem.zeroes(u32),
    mode: u16 = @import("std").mem.zeroes(u16),
    id_abbrev: u16 = @import("std").mem.zeroes(u16),
};
pub const git_diff_delta = extern struct {
    status: git_delta_t = @import("std").mem.zeroes(git_delta_t),
    flags: u32 = @import("std").mem.zeroes(u32),
    similarity: u16 = @import("std").mem.zeroes(u16),
    nfiles: u16 = @import("std").mem.zeroes(u16),
    old_file: git_diff_file = @import("std").mem.zeroes(git_diff_file),
    new_file: git_diff_file = @import("std").mem.zeroes(git_diff_file),
};
pub const git_diff_notify_cb = ?*const fn (?*const git_diff, [*c]const git_diff_delta, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
pub const git_diff_progress_cb = ?*const fn (?*const git_diff, [*c]const u8, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
pub const git_diff_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    ignore_submodules: git_submodule_ignore_t = @import("std").mem.zeroes(git_submodule_ignore_t),
    pathspec: git_strarray = @import("std").mem.zeroes(git_strarray),
    notify_cb: git_diff_notify_cb = @import("std").mem.zeroes(git_diff_notify_cb),
    progress_cb: git_diff_progress_cb = @import("std").mem.zeroes(git_diff_progress_cb),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    context_lines: u32 = @import("std").mem.zeroes(u32),
    interhunk_lines: u32 = @import("std").mem.zeroes(u32),
    oid_type: git_oid_t = @import("std").mem.zeroes(git_oid_t),
    id_abbrev: u16 = @import("std").mem.zeroes(u16),
    max_size: git_off_t = @import("std").mem.zeroes(git_off_t),
    old_prefix: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    new_prefix: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub extern fn git_diff_options_init(opts: [*c]git_diff_options, version: c_uint) c_int;
pub const git_diff_file_cb = ?*const fn ([*c]const git_diff_delta, f32, ?*anyopaque) callconv(.c) c_int;
...
pub const git_diff_binary_file = extern struct {
    type: git_diff_binary_t = @import("std").mem.zeroes(git_diff_binary_t),
    data: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    datalen: usize = @import("std").mem.zeroes(usize),
    inflatedlen: usize = @import("std").mem.zeroes(usize),
};
pub const git_diff_binary = extern struct {
    contains_data: c_uint = @import("std").mem.zeroes(c_uint),
    old_file: git_diff_binary_file = @import("std").mem.zeroes(git_diff_binary_file),
    new_file: git_diff_binary_file = @import("std").mem.zeroes(git_diff_binary_file),
};
pub const git_diff_binary_cb = ?*const fn ([*c]const git_diff_delta, [*c]const git_diff_binary, ?*anyopaque) callconv(.c) c_int;
pub const git_diff_hunk = extern struct {
    old_start: c_int = @import("std").mem.zeroes(c_int),
    old_lines: c_int = @import("std").mem.zeroes(c_int),
    new_start: c_int = @import("std").mem.zeroes(c_int),
    new_lines: c_int = @import("std").mem.zeroes(c_int),
    header_len: usize = @import("std").mem.zeroes(usize),
    header: [128]u8 = @import("std").mem.zeroes([128]u8),
};
pub const git_diff_hunk_cb = ?*const fn ([*c]const git_diff_delta, [*c]const git_diff_hunk, ?*anyopaque) callconv(.c) c_int;
...
pub const git_diff_line = extern struct {
    origin: u8 = @import("std").mem.zeroes(u8),
    old_lineno: c_int = @import("std").mem.zeroes(c_int),
    new_lineno: c_int = @import("std").mem.zeroes(c_int),
    num_lines: c_int = @import("std").mem.zeroes(c_int),
    content_len: usize = @import("std").mem.zeroes(usize),
    content_offset: git_off_t = @import("std").mem.zeroes(git_off_t),
    content: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const git_diff_line_cb = ?*const fn ([*c]const git_diff_delta, [*c]const git_diff_hunk, [*c]const git_diff_line, ?*anyopaque) callconv(.c) c_int;
...
pub const git_diff_similarity_metric = extern struct {
    file_signature: ?*const fn ([*c]?*anyopaque, [*c]const git_diff_file, [*c]const u8, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]?*anyopaque, [*c]const git_diff_file, [*c]const u8, ?*anyopaque) callconv(.c) c_int),
    buffer_signature: ?*const fn ([*c]?*anyopaque, [*c]const git_diff_file, [*c]const u8, usize, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]?*anyopaque, [*c]const git_diff_file, [*c]const u8, usize, ?*anyopaque) callconv(.c) c_int),
    free_signature: ?*const fn (?*anyopaque, ?*anyopaque) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*anyopaque) callconv(.c) void),
    similarity: ?*const fn ([*c]c_int, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]c_int, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) c_int),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const git_diff_find_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    rename_threshold: u16 = @import("std").mem.zeroes(u16),
    rename_from_rewrite_threshold: u16 = @import("std").mem.zeroes(u16),
    copy_threshold: u16 = @import("std").mem.zeroes(u16),
    break_rewrite_threshold: u16 = @import("std").mem.zeroes(u16),
    rename_limit: usize = @import("std").mem.zeroes(usize),
    metric: [*c]git_diff_similarity_metric = @import("std").mem.zeroes([*c]git_diff_similarity_metric),
};
...
pub const git_diff_parse_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    oid_type: git_oid_t = @import("std").mem.zeroes(git_oid_t),
};
...
pub const git_apply_delta_cb = ?*const fn ([*c]const git_diff_delta, ?*anyopaque) callconv(.c) c_int;
pub const git_apply_hunk_cb = ?*const fn ([*c]const git_diff_hunk, ?*anyopaque) callconv(.c) c_int;
pub const GIT_APPLY_CHECK: c_int = 1;
pub const git_apply_flags_t = c_uint;
pub const git_apply_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    delta_cb: git_apply_delta_cb = @import("std").mem.zeroes(git_apply_delta_cb),
    hunk_cb: git_apply_hunk_cb = @import("std").mem.zeroes(git_apply_hunk_cb),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
...
pub const git_attr_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: c_uint = @import("std").mem.zeroes(c_uint),
    commit_id: [*c]git_oid = @import("std").mem.zeroes([*c]git_oid),
    attr_commit_id: git_oid = @import("std").mem.zeroes(git_oid),
};
...
pub const git_attr_foreach_cb = ?*const fn ([*c]const u8, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
...
pub extern fn git_blob_data_is_binary(data: [*c]const u8, len: usize) c_int;
...
pub const struct_git_blame_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: c_uint = @import("std").mem.zeroes(c_uint),
    min_match_characters: u16 = @import("std").mem.zeroes(u16),
    newest_commit: git_oid = @import("std").mem.zeroes(git_oid),
    oldest_commit: git_oid = @import("std").mem.zeroes(git_oid),
    min_line: usize = @import("std").mem.zeroes(usize),
    max_line: usize = @import("std").mem.zeroes(usize),
};
...
pub const struct_git_blame_hunk = extern struct {
    lines_in_hunk: usize = @import("std").mem.zeroes(usize),
    final_commit_id: git_oid = @import("std").mem.zeroes(git_oid),
    final_start_line_number: usize = @import("std").mem.zeroes(usize),
    final_signature: [*c]git_signature = @import("std").mem.zeroes([*c]git_signature),
    final_committer: [*c]git_signature = @import("std").mem.zeroes([*c]git_signature),
    orig_commit_id: git_oid = @import("std").mem.zeroes(git_oid),
    orig_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    orig_start_line_number: usize = @import("std").mem.zeroes(usize),
    orig_signature: [*c]git_signature = @import("std").mem.zeroes([*c]git_signature),
    orig_committer: [*c]git_signature = @import("std").mem.zeroes([*c]git_signature),
    summary: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    boundary: u8 = @import("std").mem.zeroes(u8),
};
pub const git_blame_hunk = struct_git_blame_hunk;
pub const struct_git_blame_line = extern struct {
    ptr: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    len: usize = @import("std").mem.zeroes(usize),
};
pub const git_blame_line = struct_git_blame_line;
pub const struct_git_blame = opaque {};
pub const git_blame = struct_git_blame;
pub extern fn git_blame_linecount(blame: ?*git_blame) usize;
pub extern fn git_blame_hunkcount(blame: ?*git_blame) usize;
pub extern fn git_blame_hunk_byindex(blame: ?*git_blame, index: usize) [*c]const git_blame_hunk;
pub extern fn git_blame_hunk_byline(blame: ?*git_blame, lineno: usize) [*c]const git_blame_hunk;
pub extern fn git_blame_line_byindex(blame: ?*git_blame, idx: usize) [*c]const git_blame_line;
...
pub extern fn git_blame_file_from_buffer(out: [*c]?*git_blame, repo: ?*git_repository, path: [*c]const u8, contents: [*c]const u8, contents_len: usize, options: [*c]git_blame_options) c_int;
pub extern fn git_blame_buffer(out: [*c]?*git_blame, base: ?*git_blame, buffer: [*c]const u8, buffer_len: usize) c_int;
...
pub extern fn git_branch_create_from_annotated(ref_out: [*c]?*git_reference, repo: ?*git_repository, branch_name: [*c]const u8, target: ?*const git_annotated_commit, force: c_int) c_int;
...
pub const git_cert_hostkey = extern struct {
    parent: git_cert = @import("std").mem.zeroes(git_cert),
    type: git_cert_ssh_t = @import("std").mem.zeroes(git_cert_ssh_t),
    hash_md5: [16]u8 = @import("std").mem.zeroes([16]u8),
    hash_sha1: [20]u8 = @import("std").mem.zeroes([20]u8),
    hash_sha256: [32]u8 = @import("std").mem.zeroes([32]u8),
    raw_type: git_cert_ssh_raw_type_t = @import("std").mem.zeroes(git_cert_ssh_raw_type_t),
    hostkey: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    hostkey_len: usize = @import("std").mem.zeroes(usize),
};
...
pub const GIT_CHECKOUT_SAFE: c_int = 0;
...
pub const GIT_CHECKOUT_CONFLICT_STYLE_ZDIFF3: c_int = 33554432;
pub const GIT_CHECKOUT_NONE: c_int = 1073741824;
...
pub const git_checkout_perfdata = extern struct {
    mkdir_calls: usize = @import("std").mem.zeroes(usize),
    stat_calls: usize = @import("std").mem.zeroes(usize),
    chmod_calls: usize = @import("std").mem.zeroes(usize),
};
pub const git_checkout_notify_cb = ?*const fn (git_checkout_notify_t, [*c]const u8, [*c]const git_diff_file, [*c]const git_diff_file, [*c]const git_diff_file, ?*anyopaque) callconv(.c) c_int;
pub const git_checkout_progress_cb = ?*const fn ([*c]const u8, usize, usize, ?*anyopaque) callconv(.c) void;
pub const git_checkout_perfdata_cb = ?*const fn ([*c]const git_checkout_perfdata, ?*anyopaque) callconv(.c) void;
pub const struct_git_checkout_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    checkout_strategy: c_uint = @import("std").mem.zeroes(c_uint),
    disable_filters: c_int = @import("std").mem.zeroes(c_int),
    dir_mode: c_uint = @import("std").mem.zeroes(c_uint),
    file_mode: c_uint = @import("std").mem.zeroes(c_uint),
    file_open_flags: c_int = @import("std").mem.zeroes(c_int),
    notify_flags: c_uint = @import("std").mem.zeroes(c_uint),
    notify_cb: git_checkout_notify_cb = @import("std").mem.zeroes(git_checkout_notify_cb),
    notify_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    progress_cb: git_checkout_progress_cb = @import("std").mem.zeroes(git_checkout_progress_cb),
    progress_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    paths: git_strarray = @import("std").mem.zeroes(git_strarray),
    baseline: ?*git_tree = @import("std").mem.zeroes(?*git_tree),
    baseline_index: ?*git_index = @import("std").mem.zeroes(?*git_index),
    target_directory: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    ancestor_label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    our_label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    their_label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    perfdata_cb: git_checkout_perfdata_cb = @import("std").mem.zeroes(git_checkout_perfdata_cb),
    perfdata_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub const git_index_time = extern struct {
    seconds: i32 = @import("std").mem.zeroes(i32),
    nanoseconds: u32 = @import("std").mem.zeroes(u32),
};
pub const struct_git_index_entry = extern struct {
    ctime: git_index_time = @import("std").mem.zeroes(git_index_time),
    mtime: git_index_time = @import("std").mem.zeroes(git_index_time),
    dev: u32 = @import("std").mem.zeroes(u32),
    ino: u32 = @import("std").mem.zeroes(u32),
    mode: u32 = @import("std").mem.zeroes(u32),
    uid: u32 = @import("std").mem.zeroes(u32),
    gid: u32 = @import("std").mem.zeroes(u32),
    file_size: u32 = @import("std").mem.zeroes(u32),
    id: git_oid = @import("std").mem.zeroes(git_oid),
    flags: u16 = @import("std").mem.zeroes(u16),
    flags_extended: u16 = @import("std").mem.zeroes(u16),
    path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
...
pub const git_index_matched_path_cb = ?*const fn ([*c]const u8, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
...
pub const struct_git_index_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    oid_type: git_oid_t = @import("std").mem.zeroes(git_oid_t),
};
pub const git_index_options = struct_git_index_options;
pub extern fn git_index_options_init(opts: [*c]git_index_options, version: c_uint) c_int;
pub extern fn git_index_open(index_out: [*c]?*git_index, index_path: [*c]const u8) c_int;
pub extern fn git_index_new(index_out: [*c]?*git_index) c_int;
...
pub const GIT_MERGE_VIRTUAL_BASE: c_int = 16;
...
pub const GIT_MERGE_FILE_STYLE_ZDIFF3: c_int = 256;
pub const GIT_MERGE_FILE_ACCEPT_CONFLICTS: c_int = 512;
...
pub const git_merge_file_options = extern struct {
    ...
    our_label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    their_label: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    favor: git_merge_file_favor_t = @import("std").mem.zeroes(git_merge_file_favor_t),
    flags: u32 = @import("std").mem.zeroes(u32),
    marker_size: c_ushort = @import("std").mem.zeroes(c_ushort),
};
...
pub const git_merge_file_result = extern struct {
    automergeable: c_uint = @import("std").mem.zeroes(c_uint),
    path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    mode: c_uint = @import("std").mem.zeroes(c_uint),
    ptr: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    len: usize = @import("std").mem.zeroes(usize),
...
pub const git_merge_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    rename_threshold: c_uint = @import("std").mem.zeroes(c_uint),
    target_limit: c_uint = @import("std").mem.zeroes(c_uint),
    metric: [*c]git_diff_similarity_metric = @import("std").mem.zeroes([*c]git_diff_similarity_metric),
    recursion_limit: c_uint = @import("std").mem.zeroes(c_uint),
    default_driver: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    file_favor: git_merge_file_favor_t = @import("std").mem.zeroes(git_merge_file_favor_t),
    file_flags: u32 = @import("std").mem.zeroes(u32),
};
...
pub const git_cherrypick_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    mainline: c_uint = @import("std").mem.zeroes(c_uint),
    merge_opts: git_merge_options = @import("std").mem.zeroes(git_merge_options),
    checkout_opts: git_checkout_options = @import("std").mem.zeroes(git_checkout_options),
};
...
pub extern fn git_refspec_src_matches_negative(refspec: ?*const git_refspec, refname: [*c]const u8) c_int;
...
pub const struct_git_credential_userpass_plaintext = extern struct {
    parent: git_credential = @import("std").mem.zeroes(git_credential),
...
pub const struct_git_credential_username = extern struct {
    parent: git_credential = @import("std").mem.zeroes(git_credential),
    username: [1]u8 = @import("std").mem.zeroes([1]u8),
};
...
pub const struct_git_credential_ssh_key = extern struct {
    parent: git_credential = @import("std").mem.zeroes(git_credential),
    username: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    publickey: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    privatekey: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    passphrase: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
...
pub const git_credential_ssh_interactive_cb = ?*const fn ([*c]const u8, c_int, [*c]const u8, c_int, c_int, ?*const LIBSSH2_USERAUTH_KBDINT_PROMPT, ?*LIBSSH2_USERAUTH_KBDINT_RESPONSE, [*c]?*anyopaque) callconv(.c) void;
pub const struct_git_credential_ssh_interactive = extern struct {
    parent: git_credential = @import("std").mem.zeroes(git_credential),
    username: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    prompt_callback: git_credential_ssh_interactive_cb = @import("std").mem.zeroes(git_credential_ssh_interactive_cb),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub const git_credential_sign_cb = ?*const fn (?*LIBSSH2_SESSION, [*c][*c]u8, [*c]usize, [*c]const u8, usize, [*c]?*anyopaque) callconv(.c) c_int;
pub const struct_git_credential_ssh_custom = extern struct {
    parent: git_credential = @import("std").mem.zeroes(git_credential),
    username: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    publickey: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    publickey_len: usize = @import("std").mem.zeroes(usize),
    sign_callback: git_credential_sign_cb = @import("std").mem.zeroes(git_credential_sign_cb),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub extern fn git_packbuilder_name(pb: ?*git_packbuilder) [*c]const u8;
pub const git_packbuilder_foreach_cb = ?*const fn (?*anyopaque, usize, ?*anyopaque) callconv(.c) c_int;
...
pub const git_proxy_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    type: git_proxy_t = @import("std").mem.zeroes(git_proxy_t),
...
pub const GIT_REMOTE_REDIRECT_NONE: c_int = 1;
pub const GIT_REMOTE_REDIRECT_INITIAL: c_int = 2;
pub const GIT_REMOTE_REDIRECT_ALL: c_int = 4;
pub const git_remote_redirect_t = c_uint;
...
pub const GIT_REMOTE_UPDATE_FETCHHEAD: c_int = 1;
pub const GIT_REMOTE_UPDATE_REPORT_UNCHANGED: c_int = 2;
pub const git_remote_update_flags = c_uint;
pub const struct_git_remote_create_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    repository: ?*git_repository = @import("std").mem.zeroes(?*git_repository),
    name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    fetchspec: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    flags: c_uint = @import("std").mem.zeroes(c_uint),
};
...
pub const git_push_update = extern struct {
    src_refname: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    dst_refname: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    src: git_oid = @import("std").mem.zeroes(git_oid),
    dst: git_oid = @import("std").mem.zeroes(git_oid),
};
...
pub const GIT_FETCH_DEPTH_FULL: c_int = 0;
pub const GIT_FETCH_DEPTH_UNSHALLOW: c_int = 2147483647;
pub const git_fetch_depth_t = c_uint;
pub const git_fetch_options = extern struct {
    version: c_int = @import("std").mem.zeroes(c_int),
    callbacks: git_remote_callbacks = @import("std").mem.zeroes(git_remote_callbacks),
    prune: git_fetch_prune_t = @import("std").mem.zeroes(git_fetch_prune_t),
    update_fetchhead: c_uint = @import("std").mem.zeroes(c_uint),
    download_tags: git_remote_autotag_option_t = @import("std").mem.zeroes(git_remote_autotag_option_t),
    proxy_opts: git_proxy_options = @import("std").mem.zeroes(git_proxy_options),
    depth: c_int = @import("std").mem.zeroes(c_int),
    follow_redirects: git_remote_redirect_t = @import("std").mem.zeroes(git_remote_redirect_t),
    custom_headers: git_strarray = @import("std").mem.zeroes(git_strarray),
};
...
pub const git_push_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    pb_parallelism: c_uint = @import("std").mem.zeroes(c_uint),
    callbacks: git_remote_callbacks = @import("std").mem.zeroes(git_remote_callbacks),
    proxy_opts: git_proxy_options = @import("std").mem.zeroes(git_proxy_options),
    follow_redirects: git_remote_redirect_t = @import("std").mem.zeroes(git_remote_redirect_t),
    custom_headers: git_strarray = @import("std").mem.zeroes(git_strarray),
    remote_push_options: git_strarray = @import("std").mem.zeroes(git_strarray),
};
pub extern fn git_push_options_init(opts: [*c]git_push_options, version: c_uint) c_int;
pub const git_remote_connect_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    callbacks: git_remote_callbacks = @import("std").mem.zeroes(git_remote_callbacks),
    proxy_opts: git_proxy_options = @import("std").mem.zeroes(git_proxy_options),
    follow_redirects: git_remote_redirect_t = @import("std").mem.zeroes(git_remote_redirect_t),
...
pub extern fn git_remote_connect_options_init(opts: [*c]git_remote_connect_options, version: c_uint) c_int;
...
pub extern fn git_remote_connect_ext(remote: ?*git_remote, direction: git_direction, opts: [*c]const git_remote_connect_options) c_int;
...
pub extern fn git_remote_update_tips(remote: ?*git_remote, callbacks: [*c]const git_remote_callbacks, update_flags: c_uint, download_tags: git_remote_autotag_option_t, reflog_message: [*c]const u8) c_int;
...
pub const git_remote_create_cb = ?*const fn ([*c]?*git_remote, ?*git_repository, [*c]const u8, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
pub const git_repository_create_cb = ?*const fn ([*c]?*git_repository, [*c]const u8, c_int, ?*anyopaque) callconv(.c) c_int;
pub const struct_git_clone_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    checkout_opts: git_checkout_options = @import("std").mem.zeroes(git_checkout_options),
    fetch_opts: git_fetch_options = @import("std").mem.zeroes(git_fetch_options),
    bare: c_int = @import("std").mem.zeroes(c_int),
    local: git_clone_local_t = @import("std").mem.zeroes(git_clone_local_t),
    checkout_branch: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    repository_cb: git_repository_create_cb = @import("std").mem.zeroes(git_repository_create_cb),
    repository_cb_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    remote_cb: git_remote_create_cb = @import("std").mem.zeroes(git_remote_create_cb),
    remote_cb_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub const GIT_CONFIG_LEVEL_WORKTREE: c_int = 6;
pub const GIT_CONFIG_LEVEL_APP: c_int = 7;
...
pub const struct_git_config_entry = extern struct {
    ...
    backend_type: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    origin_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    include_depth: c_uint = @import("std").mem.zeroes(c_uint),
    level: git_config_level_t = @import("std").mem.zeroes(git_config_level_t),
};
pub const git_config_entry = struct_git_config_entry;
pub extern fn git_config_entry_free(entry: [*c]git_config_entry) void;
pub const git_config_foreach_cb = ?*const fn ([*c]const git_config_entry, ?*anyopaque) callconv(.c) c_int;
...
pub const git_configmap = extern struct {
    type: git_configmap_t = @import("std").mem.zeroes(git_configmap_t),
    str_match: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    map_value: c_int = @import("std").mem.zeroes(c_int),
};
...
pub extern fn git_config_set_writeorder(cfg: ?*git_config, levels: [*c]git_config_level_t, len: usize) c_int;
...
pub const struct_git_describe_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    max_candidates_tags: c_uint = @import("std").mem.zeroes(c_uint),
    describe_strategy: c_uint = @import("std").mem.zeroes(c_uint),
    pattern: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    only_follow_first_parent: c_int = @import("std").mem.zeroes(c_int),
    show_commit_oid_as_fallback: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const git_describe_format_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    abbreviated_size: c_uint = @import("std").mem.zeroes(c_uint),
    always_use_long_format: c_int = @import("std").mem.zeroes(c_int),
    dirty_suffix: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
...
pub const GIT_EOWNER: c_int = -36;
pub const GIT_TIMEOUT: c_int = -37;
pub const GIT_EUNCHANGED: c_int = -38;
pub const GIT_ENOTSUPPORTED: c_int = -39;
pub const GIT_EREADONLY: c_int = -40;
...
pub const git_rebase_options = extern struct {
    ...
    inmemory: c_int = @import("std").mem.zeroes(c_int),
    rewrite_notes_ref: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    merge_options: git_merge_options = @import("std").mem.zeroes(git_merge_options),
    checkout_options: git_checkout_options = @import("std").mem.zeroes(git_checkout_options),
    commit_create_cb: git_commit_create_cb = @import("std").mem.zeroes(git_commit_create_cb),
    signing_cb: ?*const fn ([*c]git_buf, [*c]git_buf, [*c]const u8, ?*anyopaque) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]git_buf, [*c]git_buf, [*c]const u8, ?*anyopaque) callconv(.c) c_int),
    payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub const git_rebase_operation = extern struct {
    type: git_rebase_operation_t = @import("std").mem.zeroes(git_rebase_operation_t),
    id: git_oid = @import("std").mem.zeroes(git_oid),
    exec: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
...
pub const git_trace_cb = ?*const fn (git_trace_level_t, [*c]const u8) callconv(.c) void;
...
pub const git_revspec = extern struct {
    from: ?*git_object = @import("std").mem.zeroes(?*git_object),
    to: ?*git_object = @import("std").mem.zeroes(?*git_object),
    flags: c_uint = @import("std").mem.zeroes(c_uint),
};
...
pub const GIT_STASH_KEEP_ALL: c_int = 8;
...
pub const struct_git_stash_save_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    stasher: [*c]const git_signature = @import("std").mem.zeroes([*c]const git_signature),
    message: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    paths: git_strarray = @import("std").mem.zeroes(git_strarray),
};
pub const git_stash_save_options = struct_git_stash_save_options;
pub extern fn git_stash_save_options_init(opts: [*c]git_stash_save_options, version: c_uint) c_int;
pub extern fn git_stash_save_with_opts(out: [*c]git_oid, repo: ?*git_repository, opts: [*c]const git_stash_save_options) c_int;
...
pub const git_stash_apply_progress_cb = ?*const fn (git_stash_apply_progress_t, ?*anyopaque) callconv(.c) c_int;
pub const struct_git_stash_apply_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    checkout_options: git_checkout_options = @import("std").mem.zeroes(git_checkout_options),
    progress_cb: git_stash_apply_progress_cb = @import("std").mem.zeroes(git_stash_apply_progress_cb),
    progress_payload: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub const git_stash_cb = ?*const fn (usize, [*c]const u8, [*c]const git_oid, ?*anyopaque) callconv(.c) c_int;
...
pub const git_status_cb = ?*const fn ([*c]const u8, c_uint, ?*anyopaque) callconv(.c) c_int;
...
pub const git_status_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    show: git_status_show_t = @import("std").mem.zeroes(git_status_show_t),
    flags: c_uint = @import("std").mem.zeroes(c_uint),
    pathspec: git_strarray = @import("std").mem.zeroes(git_strarray),
    baseline: ?*git_tree = @import("std").mem.zeroes(?*git_tree),
    rename_threshold: u16 = @import("std").mem.zeroes(u16),
...
pub const git_status_entry = extern struct {
    status: git_status_t = @import("std").mem.zeroes(git_status_t),
    head_to_index: [*c]git_diff_delta = @import("std").mem.zeroes([*c]git_diff_delta),
    index_to_workdir: [*c]git_diff_delta = @import("std").mem.zeroes([*c]git_diff_delta),
};
...
pub const git_submodule_cb = ?*const fn (?*git_submodule, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
pub const struct_git_submodule_update_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    checkout_opts: git_checkout_options = @import("std").mem.zeroes(git_checkout_options),
    fetch_opts: git_fetch_options = @import("std").mem.zeroes(git_fetch_options),
    allow_fetch: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const struct_git_credential_userpass_payload = extern struct {
    username: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    password: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
...
pub const git_commit_signing_cb = ?*const fn ([*c]git_buf, [*c]git_buf, [*c]const u8, ?*anyopaque) callconv(.c) c_int;
...
pub const git_diff_format_email_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    patch_no: usize = @import("std").mem.zeroes(usize),
    total_patches: usize = @import("std").mem.zeroes(usize),
    id: [*c]const git_oid = @import("std").mem.zeroes([*c]const git_oid),
    summary: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    body: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    author: [*c]const git_signature = @import("std").mem.zeroes([*c]const git_signature),
};
...
pub const git_headlist_cb = ?*const fn ([*c]git_remote_head, ?*anyopaque) callconv(.c) c_int;
...
pub const git_email_create_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
    diff_opts: git_diff_options = @import("std").mem.zeroes(git_diff_options),
    diff_find_opts: git_diff_find_options = @import("std").mem.zeroes(git_diff_find_options),
    subject_prefix: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    start_number: usize = @import("std").mem.zeroes(usize),
    reroll_number: usize = @import("std").mem.zeroes(usize),
};
...
pub const git_message_trailer_array = extern struct {
    trailers: [*c]git_message_trailer = @import("std").mem.zeroes([*c]git_message_trailer),
    count: usize = @import("std").mem.zeroes(usize),
    _trailer_block: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
...
pub const git_note_foreach_cb = ?*const fn ([*c]const git_oid, [*c]const git_oid, ?*anyopaque) callconv(.c) c_int;
...
pub const git_odb_backend_pack_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    oid_type: git_oid_t = @import("std").mem.zeroes(git_oid_t),
};
pub const GIT_ODB_BACKEND_LOOSE_FSYNC: c_int = 1;
pub const git_odb_backend_loose_flag_t = c_uint;
pub const git_odb_backend_loose_options = extern struct {
    version: c_uint = @import("std").mem.zeroes(c_uint),
    flags: u32 = @import("std").mem.zeroes(u32),
...
pub extern fn git_reset_from_annotated(repo: ?*git_repository, target: ?*const git_annotated_commit, reset_type: git_reset_t, checkout_opts: [*c]const git_checkout_options) c_int;
...
pub const git_revwalk_hide_cb = ?*const fn ([*c]const git_oid, ?*anyopaque) callconv(.c) c_int;
...
pub extern fn git_signature_default_from_env(author_out: [*c][*c]git_signature, committer_out: [*c][*c]git_signature, repo: ?*git_repository) c_int;
...
pub const git_tag_foreach_cb = ?*const fn ([*c]const u8, [*c]git_oid, ?*anyopaque) callconv(.c) c_int;
...
pub const GIT_EXTERN = @compileError("unable to translate macro: undefined identifier `visibility`");
// include/git2/common.h:41:10
pub inline fn GIT_CALLBACK(name: anytype) @TypeOf(name.*) {
    _ = &name;
    return name.*;
}
pub const GIT_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`");
// include/git2/common.h:59:10
pub const GIT_FORMAT_PRINTF = @compileError("unable to translate macro: undefined identifier `format`");
// include/git2/common.h:71:10
...
pub const GIT_BUF_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/buffer.h:61:9
pub const INCLUDE_git_oid_h__ = "";
pub const INCLUDE_experimental_h__ = "";
pub const GIT_OID_DEFAULT = GIT_OID_SHA1;
pub const GIT_OID_SHA1_SIZE = @as(c_int, 20);
pub const GIT_OID_SHA1_HEXSIZE = GIT_OID_SHA1_SIZE * @as(c_int, 2);
pub const GIT_OID_SHA1_ZERO = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/oid.h:51:10
pub const GIT_OID_SHA1_HEXZERO = "0000000000000000000000000000000000000000";
pub const GIT_OID_MAX_SIZE = GIT_OID_SHA1_SIZE;
pub const GIT_OID_MAX_HEXSIZE = GIT_OID_SHA1_HEXSIZE;
pub const GIT_OID_MINPREFIXLEN = @as(c_int, 4);
pub const INCLUDE_git_odb_h__ = "";
pub const INCLUDE_git_oidarray_h__ = "";
pub const INCLUDE_git_indexer_h__ = "";
pub const GIT_INDEXER_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_INDEXER_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/indexer.h:106:9
pub const GIT_ODB_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_ODB_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/odb.h:63:9
pub const INCLUDE_git_commit_h__ = "";
pub const INCLUDE_git_object_h__ = "";
pub const GIT_OBJECT_SIZE_MAX = UINT64_MAX;
pub const GIT_COMMIT_CREATE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_COMMIT_CREATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/commit.h:458:9
pub const GIT_REPOSITORY_INIT_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_REPOSITORY_INIT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/repository.h:386:9
...
pub const GIT_DIFF_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/diff.h:479:9
pub const GIT_DIFF_HUNK_HEADER_SIZE = @as(c_int, 128);
pub const GIT_DIFF_FIND_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_DIFF_FIND_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/diff.h:834:9
pub const GIT_DIFF_PARSE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_DIFF_PARSE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/diff.h:1335:9
pub const GIT_DIFF_PATCHID_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_DIFF_PATCHID_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/diff.h:1497:9
pub const GIT_APPLY_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_APPLY_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/apply.h:115:9
...
pub const GIT_ATTR_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/attr.h:177:9
pub const INCLUDE_git_blob_h__ = "";
pub const GIT_BLOB_FILTER_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_BLOB_FILTER_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/blob.h:186:9
pub const INCLUDE_git_blame_h__ = "";
pub const GIT_BLAME_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_BLAME_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/blame.h:134:9
...
pub const GIT_CHECKOUT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/checkout.h:398:9
...
pub const GIT_INDEX_ENTRY_STAGE_SET = @compileError("unable to translate C expr: unexpected token 'do'");
// include/git2/index.h:111:9
pub const GIT_INDEX_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_INDEX_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/index.h:217:9
pub const GIT_MERGE_FILE_INPUT_VERSION = @as(c_int, 1);
pub const GIT_MERGE_FILE_INPUT_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/merge.h:55:9
pub const GIT_MERGE_CONFLICT_MARKER_SIZE = @as(c_int, 7);
pub const GIT_MERGE_FILE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_MERGE_FILE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/merge.h:231:9
pub const GIT_MERGE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_MERGE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/merge.h:329:9
pub const GIT_CHERRYPICK_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_CHERRYPICK_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/cherrypick.h:43:9
...
pub const GIT_PROXY_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/proxy.h:91:9
pub const GIT_REMOTE_CREATE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_REMOTE_CREATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/remote.h:123:9
pub const GIT_REMOTE_CALLBACKS_VERSION = @as(c_int, 1);
pub const GIT_REMOTE_CALLBACKS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/remote.h:704:9
pub const GIT_FETCH_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_FETCH_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/remote.h:834:9
pub const GIT_PUSH_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_PUSH_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/remote.h:905:9
pub const GIT_REMOTE_CONNECT_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_REMOTE_CONNECT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/remote.h:952:9
pub const GIT_CLONE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_CLONE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/clone.h:177:9
...
pub const GIT_DESCRIBE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/describe.h:76:9
pub const GIT_DESCRIBE_FORMAT_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_DESCRIBE_FORMAT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/describe.h:126:9
pub const INCLUDE_git_errors_h__ = "";
pub const INCLUDE_git_filter_h__ = "";
pub const GIT_FILTER_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_FILTER_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/filter.h:92:9
pub const INCLUDE_git_rebase_h__ = "";
pub const GIT_REBASE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_REBASE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/rebase.h:161:9
...
pub const GIT_REVERT_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/revert.h:40:9
pub const INCLUDE_git_revparse_h__ = "";
pub const INCLUDE_git_stash_h__ = "";
pub const GIT_STASH_SAVE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_STASH_SAVE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/stash.h:106:9
pub const GIT_STASH_APPLY_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_STASH_APPLY_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/stash.h:210:9
...
pub const GIT_STATUS_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/status.h:268:9
...
pub const GIT_SUBMODULE_UPDATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/submodule.h:164:9
pub const INCLUDE_git_worktree_h__ = "";
pub const GIT_WORKTREE_ADD_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_WORKTREE_ADD_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/worktree.h:103:9
pub const GIT_WORKTREE_PRUNE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_WORKTREE_PRUNE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/worktree.h:221:9
...
pub const GIT_BUF_INIT_CONST = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/deprecated.h:206:9
...
pub const GIT_DIFF_FORMAT_EMAIL_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/deprecated.h:366:9
...
pub const GIT_ERROR_SHA1 = GIT_ERROR_SHA;
...
pub const GIT_OBJ_OFS_DELTA = @compileError("unable to translate macro: undefined identifier `GIT_OBJECT_OFS_DELTA`");
// include/git2/deprecated.h:650:9
pub const GIT_OBJ_REF_DELTA = @compileError("unable to translate macro: undefined identifier `GIT_OBJECT_REF_DELTA`");
// include/git2/deprecated.h:652:9
...
pub const GIT_REPOSITORY_INIT_NO_DOTGIT_DIR = @as(c_int, 0);
...
pub const GIT_OID_RAWSZ = GIT_OID_SHA1_SIZE;
pub const GIT_OID_HEXSZ = GIT_OID_SHA1_HEXSIZE;
pub const GIT_OID_HEX_ZERO = GIT_OID_SHA1_HEXZERO;
pub const git_remote_completion_type = git_remote_completion_t;
pub const LIBGIT2_VER_MAJOR = LIBGIT2_VERSION_MAJOR;
pub const LIBGIT2_VER_MINOR = LIBGIT2_VERSION_MINOR;
pub const LIBGIT2_VER_REVISION = LIBGIT2_VERSION_REVISION;
pub const LIBGIT2_VER_PATCH = LIBGIT2_VERSION_PATCH;
pub const LIBGIT2_VER_PRERELEASE = LIBGIT2_VERSION_PRERELEASE;
pub const INCLUDE_git_email_h__ = "";
pub const GIT_EMAIL_CREATE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_EMAIL_CREATE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/email.h:82:9
...
pub const GIT_ODB_BACKEND_PACK_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_ODB_BACKEND_PACK_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/odb_backend.h:41:9
pub const GIT_ODB_BACKEND_LOOSE_OPTIONS_VERSION = @as(c_int, 1);
pub const GIT_ODB_BACKEND_LOOSE_OPTIONS_INIT = @compileError("unable to translate C expr: unexpected token '{'");
// include/git2/odb_backend.h:84:9
...
pub const LIBGIT2_VERSION = "1.9.0";
pub const LIBGIT2_VERSION_MAJOR = @as(c_int, 1);
pub const LIBGIT2_VERSION_MINOR = @as(c_int, 9);
pub const LIBGIT2_VERSION_REVISION = @as(c_int, 0);
pub const LIBGIT2_VERSION_PATCH = @as(c_int, 0);
pub const LIBGIT2_VERSION_PRERELEASE = NULL;
pub const LIBGIT2_SOVERSION = "1.9";
pub const LIBGIT2_VERSION_NUMBER = ((LIBGIT2_VERSION_MAJOR * @import("std").zig.c_translation.promoteIntLiteral(c_int, 1000000, .decimal)) + (LIBGIT2_VERSION_MINOR * @as(c_int, 10000))) + (LIBGIT2_VERSION_REVISION * @as(c_int, 100));
pub inline fn LIBGIT2_VERSION_CHECK(major: anytype, minor: anytype, revision: anytype) @TypeOf(LIBGIT2_VERSION_NUMBER >= (((major * @import("std").zig.c_translation.promoteIntLiteral(c_int, 1000000, .decimal)) + (minor * @as(c_int, 10000))) + (revision * @as(c_int, 100)))) {
    _ = &major;
    _ = &minor;
    _ = &revision;
    return LIBGIT2_VERSION_NUMBER >= (((major * @import("std").zig.c_translation.promoteIntLiteral(c_int, 1000000, .decimal)) + (minor * @as(c_int, 10000))) + (revision * @as(c_int, 100)));
}
