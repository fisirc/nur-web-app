    ...
    <ScrollArea className="grow">
      <div className="flex flex-col px-6 pt-6">
        ...
        <Tabs defaultValue="logs" className="mt-6 flex flex-1 flex-col">
          ...
          <TabsContent value="logs" className="mt-4 flex flex-1 flex-col">
          ...
          <TabsContent value="test" className="mt-4 flex flex-1 flex-col">
            <div className="bg-sidebar flex-1 rounded-md p-4">
              ...
              <div className="bg-background border-border flex h-full min-h-[500px] gap-4 rounded-lg border p-4">
                ...
                <div className="flex flex-1 flex-col">
                  ...
                  <div className="bg-sidebar border-border min-h-0 flex-1 overflow-hidden rounded-lg border p-4">
                    {response ? (
                        ...
                        {response.error ? (
                          ...
                          <>
                            ...
                            {response.headers &&
                              Object.keys(response.headers).length > 0 && (
                                <div className="mb-4">
                                  ...
                                  <div className="bg-background max-h-24 overflow-y-auto rounded p-2">
                            ...
                            <div className="min-h-0 flex-1">
                              ...
                              <div className="bg-background h-full overflow-auto rounded p-4">
